...
import { userRecord } from "../../config/Utils"

const UserAdd = () => {
    const [uAdd, setUadd] = useState(userRecord);
                        ...
                        <div style={{ boxShadow: "10px 10px 5px gray " }} className="card p-4 mt-5" s>
                            <form >
                                ...
                                <div className="form-group mt-2">
                                    ...
                                    <input onChange={handleChange} type="email" className="form-control" id="email" name="email" placeholder="Password" aria-describedby="passwordHelp" />
                                </div>
